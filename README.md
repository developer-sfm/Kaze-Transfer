...
## 📱 Mobiles and Tablets
- The web interface is optimized for **landscape mode only**
- Portrait mode may cause bugs and misalignment
- If the interface appears too large on first load, zoom out until the layout fits normally
